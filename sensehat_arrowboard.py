...
# Set a var pause to 3 (the initial time between turns)
# Set var score and angle to 0
# Create a var called play set to True (this will be used to stop the game later)
pause = 3
score = 0
angle = 0
play = True
